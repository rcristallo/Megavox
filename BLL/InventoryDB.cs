...
namespace MegaVox.BLL
{
    class InventoryDB
    {
        ...
        public bool insertInventory(string InvName, string price, string desc)
        {
            ...
            cmdInsert.Parameters.Add("@pc", MySqlDbType.VarChar).Value = price;
        ...
        public DataTable searchInventory(string searchdata)
        {
            MySqlCommand command = new MySqlCommand("SELECT * FROM `inventory` WHERE CONCAT(`InvName`,`Description`,`Price`) LIKE '%" + searchdata + "%'", connect.getconnection);
            MySqlDataAdapter adapter = new MySqlDataAdapter(command);
            DataTable table = new DataTable();
            adapter.Fill(table);
            return table;
        ...
        public bool updateInventory(int id, string InvName, string price, string desc)
        {
            ...
            cmdUpdate.Parameters.Add("@pc", MySqlDbType.VarChar).Value = price;
